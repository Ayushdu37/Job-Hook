...
const ExpInput = (props:any)=>{
    ...
    return <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-10 [&>*]:w-1/2">
         ...
         <Textarea withAsterisk label="Summary" autosize minRows={3} placeholder="Enter Summary..." 
               value={desc}
    ...
    <MonthPickerInput disabled={checked} withAsterisk minDate={startDate||undefined} maxDate={new Date()}
      label="End date"
      placeholder="Pick date"
      value={endDate}
      onChange={setEndDate}/>
